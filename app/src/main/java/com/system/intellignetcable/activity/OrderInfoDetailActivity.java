...
public class OrderInfoDetailActivity extends BaseActivity {
                                    ...
                                    for (int i = 0; i < epcs.size(); i++) {
                                        ...
                                        naviBtn.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                Poi end = new Poi(listBean.getDetailAddress(), new LatLng(Double.parseDouble(listBean.getLatitude()), Double.parseDouble(listBean.getLongitude())), "");
    ...
    private void updateData(OrderInfoDetailBean.WorkOrderBean workOrderBean) {
        ...
        placeTv.setText(workOrderBean.getWorkAddress());
    }
    ...
    public void onScan() {
        IntentHelper.jumpScanActivity(OrderInfoDetailActivity.this, true, workOrderId);
    }
}
